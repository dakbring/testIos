...
//  MedicalAlarm
//
//  Created by Lam Pham on 1/18/20.
...
extension UIView {
    ...
    func setBorder(borderWidth: CGFloat = 1, borderColor: UIColor = UIColor.clear, cornerRadius: CGFloat, corners: UIRectCorner = .allCorners ) {
        self.layer.masksToBounds        = true
        addBorder(color: borderColor, cornerRadius: cornerRadius, borderWidth: borderWidth)
    }
    func addBorder(color: UIColor, cornerRadius: CGFloat = 5, borderWidth: CGFloat = 1, corners: UIRectCorner = .allCorners) {
...
extension Date {
    ...
    static let dateFormatToTime = "HH:mm"
    static let dateFormatShorter = "dd MMMM yyyy"
    ...
    func formattedTime(dateFormat: String = dateFormatToTime) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = dateFormat
        let dateString = dateFormatter.string(from: self)
        return dateString
    ...
    func formattedShoter(dateFormat: String = dateFormatShorter) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = dateFormat
        let dateString = dateFormatter.string(from: self)
        return dateString
...
class OwnTableView: UITableView {
    ...
    var exHeight: CGFloat = 0
    
    override var intrinsicContentSize: CGSize {
        self.layoutIfNeeded()
        return CGSize(width: self.contentSize.width, height: self.contentSize.height + exHeight)
    }
